/**
 * Deck 1 "Présentation déploiement" — traduit en août 2026.
 *
 * Conservé pour mémoire. Son vocabulaire réutilisable est déjà passé dans
 * glossaire.gs ; ne pas coller ce fichier dans le projet Apps Script.
 */
