...
import type { EcartFleche, EtapeFlux, FlecheTracee } from './moteur.js';
...
export function memeColonne(etapes: EtapeFlux[], a: number, b: number): boolean;
export function tirerFleche(
  etapes: EtapeFlux[],
  source: number,
  cible: number,
