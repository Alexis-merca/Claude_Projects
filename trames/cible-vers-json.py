...
UC = [
 ("pilotage-competences", "UC 6 - Pilotage des compétences",
  ...
  [
   ...
   ("À l'événement", "Chef d'équipe", "Retrouve la matrice à jour après une formation validée, une arrivée ou une mobilité, sans l'avoir ressaisie", "Mercateam (Master)"),
 ...
 ("planification-et-gestion-aleas", "UC 1 - Planification des opérateurs et gestion des aléas",
  ...
  [
   ...
   ("Continu", "RH", "Ne ressaisit plus les absences, congés et contraintes individuelles : ils remontent du SIRH", "Logiciel (SIRH / GTA), Mercateam (Planner)"),
   ...
   ("Jour J", "Chef d'équipe", "Reçoit une alerte quand le remplaçant pressenti n'est pas habilité au poste", "Mercateam (Planner)"),
 ...
 ("integration", "UC 3 - Intégration des nouveaux collaborateurs",
  ...
  [
   ...
   ("J+X", "Chef d'équipe", "Retrouve la matrice de polyvalence à jour dès la validation, sans ressaisie", "Mercateam (Master)"),
 ...
 ("transfert-savoir-faire", "UC 4 - Capitalisation et transfert des savoir-faire critiques",
  ...
  [
   ...
   ("Mensuel", "Chef d'équipe", "Reçoit l'alerte des compétences à revalider avant leur expiration", "Mercateam (Trainer)"),
 ...
 ("habilitations", "UC 7 - Maîtrise des habilitations et sécurité au poste",
  ...
  [
   ...
   ("Continu", "QHSE / EHS", "Suit les échéances sur un tableau unique, sans tenir de fichier parallèle", "Mercateam (Trainer)"),
   ("Mensuel", "Responsable formation", "Reçoit l'alerte des recyclages à programmer, deux mois avant échéance", "Mercateam (Trainer)"),
   ("À l'événement", "RH", "Dépose l'attestation de l'organisme sur la fiche du collaborateur, datée automatiquement", "Mercateam (Trainer)"),
   ("Hebdo (S-1)", "Planificateur opérateurs", "Ne peut plus affecter un opérateur non habilité : l'outil bloque avant validation", "Mercateam (Planner)"),
   ("Jour J", "Chef d'équipe", "Reçoit l'alerte avant d'affecter, et non après l'incident", "Mercateam (Planner)"),
   ("Continu", "Collaborateur", "Consulte ses habilitations et leurs dates de validité sur sa fiche", "Mercateam (Starter)"),
 ...
 ("audits", "UC 8 - Préparation et tenue des audits",
  ...
  [
   ...
   ("Continu", "Responsable compétences", "Produit les preuves de formation au fil de l'eau, datées à chaque validation", "Mercateam (Trainer)"),
   ("Continu", "QHSE / EHS", "Dépose les documents de conformité sur la fiche du collaborateur", "Mercateam (Starter)"),
 ...
 ("equite-affectations", "UC 9 - Équité et traçabilité des affectations",
  ...
  [
   ...
   ("Continu", "Planificateur opérateurs", "Équilibre la rotation sur les postes contraignants, suivie automatiquement", "Mercateam (Planner)"),
   ("Continu", "Collaborateur", "Consulte ses affectations passées et les critères qui les ont motivées", "Mercateam (Planner)"),
 ...
 ("reconnaissance", "UC 10 - Reconnaissance et rémunération des compétences",
  ...
  [
   ...
   ("Continu", "Collaborateur", "Consulte les compétences requises, son positionnement et ce qui lui manque pour progresser", "Mercateam (Master)"),
